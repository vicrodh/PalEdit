...
languagemenu.add_radiobutton(label="日本語", command=lambda: change_language('ja'), variable=selected_language)
languagemenu.add_radiobutton(label="Français", command=lambda: change_language('fr'), variable=selected_language)
languagemenu.add_radiobutton(label="简体中文", command=lambda: change_language('zh_CN'), variable=selected_language)
